...
| **[AI Native]**           |                              |          |                                                   |
| `/product/ai-agent/`      | **AIエージェント**           | SSR      | チャットボットではない、チームの一員としてのAI。  |
| `/product/rag/`           | **組織の記憶 (RAG)**         | SSR      | PDF/ドキュメントからの知識化と検索。              |
| `/product/mcp/`           | **自律的実行 (MCP)**         | SSR      | タスク管理、進捗監視、外部連携。                  |
| `/product/byok/`          | **透明性とコスト (BYOK)**    | SSR      | 自身のAPIキー活用によるデータ保護とコスト最適化。 |
| **[Product Legal]**       |                              |          |                                                   |
