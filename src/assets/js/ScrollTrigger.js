  ...
  return function (defaultOptions, bindTo, scrollIn) {
    ...
    var Trigger = function (_defaultOptions, _element) {
      ...
      this.init = function (_this) {
        return function () {
          ...
          // parse callbacks
          _this.showCallback =
            _this.element.hasAttribute("data-scroll-showCallback")
              ? _this.element.getAttribute("data-scroll-showCallback")
              : _this.showCallback;
          _this.hideCallback =
            _this.element.hasAttribute("data-scroll-hideCallback")
              ? _this.element.getAttribute("data-scroll-hideCallback")
              : _this.hideCallback;
    ...
    function update() {
      ...
      var currentTop = !_this.bindElement.scrollTop
        ...
        : _this.bindElement.scrollTop;
      var currentLeft = !_this.bindElement.scrollLeft
        ? document.documentElement.scrollLeft
        : _this.bindElement.scrollLeft;
    ...
    this.scrollDidChange = function (_this) {
      return function () {
        var windowWidth = _this.scrollElement.innerWidth ||
          _this.scrollElement.offsetWidth;
        var windowHeight = _this.scrollElement.innerHeight ||
          _this.scrollElement.offsetHeight;
        ...
        triggers.each(function (trigger, index) {
          ...
          // toggle the classes
          if (
            triggerLeft < windowWidth && triggerLeft >= 0 &&
