...
export const title = "事例紹介 | クリップクロウ";
...
export default () => (
  <main>
    <section id="contents_top">
      <div className="inner">
        <h1>
          <span className="txt_en">Case Study</span>
          <span className="txt_j">事例紹介</span>
        </h1>
    ...
    <section className="main_contents">
      ...
      <article id="case01" className="case_item">
        ...
        <div className="case_contents">
          <p>
            2020年1月よりプロジェクトの中心として開発チームの組成やアーキテクチャから実行した。開発するEHRはSaaSとして、Google
            Cloud上で実装。開発体制は最大時には50名規模となった。2022年6月まで従事した。
          </p>
          <div className="casestudy_img_wide">
            <img
              src="casestudy_img01_pc.png"
              alt="クラウド電子カルテ開発案件"
              className="switch"
            />
          </div>
      ...
      <article id="case02" className="case_item">
        <div className="case_title">
          ...
          <div className="case_title_txt">
            ...
            <div className="case_title_jp">
              <h2>国立大学病院の治験プラットフォーム</h2>
            </div>
          </div>
        </div>
        <div className="case_contents">
          <p>
            2020年9月コロナ禍の下、助成金による医療機関ICT実証実験プロジェクトが募集されたときに採択されたいくつかの組織のうちの一つ。国立大学医学部附属病院への実証実験プロジェクト実施支援の依頼があり参画。RFP
            作成を支援し、他方、大学との協働にて応札書類を作成した。その後の開発全量について受託した。
          </p>
      ...
      <article id="case04" className="case_item">
        ...
        <div className="case_contents">
          ...
          <div className="case_txt">
            ...
            <ul>
              <li>
                遠隔診療所と遠隔薬局をTwilio APIで実現。APIのEoSにより今後はZoom
                APIへ移行を予定
              </li>
              <li>
                予約〜診療〜処方の一連をスムーズに行うためUX検討にリソースを費やす
              </li>
              <li>
                薬の配送のオペレーションと必要なStripe決済など背後システムの開発
              </li>
      ...
      <article id="case05" className="case_item">
        ...
        <div className="case_contents">
          ...
          <div className="case_txt">
            <h3>内容</h3>
            <ul>
              <li>全従業員に歩数計を配りスマホのNFC読み取りで記録する</li>
              <li>
                運動量に応じて社内通貨が報奨として与えられ、やはりスマホ上に用意したカタログギフト機能で健康グッズやサプリやグループ経営の健康食レストラン食事券に交換できるなどとした。これら一連の機能が一体化している
              </li>
              <li>
                企業側管理者は、専用のWEBコンソールによって情報可視化と健康経営施策の集中管理を行う
              </li>
              <li>FlutterとGolangにより、AWS上で運用している</li>
            </ul>
          </div>
      ...
      <article id="case06" className="case_item">
        ...
        <div className="case_contents">
          <p>
            2022年7月〜2025年12月に、Medtech
            スタートアップのインテグリティ・ヘルスケアと当初はSIパートナーシップを構築し、その後同社の技術フェロー(非常勤)に就任した。健康経営をテーマとしたSaaS事業とSIに従事。PHR製品の拡張機能群を開発した。
          </p>
          <div className="case_txt">
            <h3>内容</h3>
            <ul>
              <li>
                <a
                  href="https://www.integrity-healthcare.co.jp/"
                  target="_blank"
                >
                  株式会社インテグリティ・ヘルスケア
                </a>
              ...
              <li>
                PHR 製品の特定疾患管理機能を医療機関向け WEB
                画面および既存スマホアプリへの組み込みで患者向け機能を提供
              </li>
              <li>
                健康診断結果の収集と表示、その後に結果の悪い従業員に対して受診勧奨を含む行動変容を促す機能を、健康経営に取り組む大企業向けに提供
              </li>
            </ul>
          </div>
        </div>
