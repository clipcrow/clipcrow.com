        ...
        <div className="casestudy_index">
          ...
          >
            ...
            <div className="casestudy_txt">
              ...
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case01">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="casestudy_txt">
              ...
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case02">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="casestudy_txt">
              ...
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case03">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="casestudy_txt">
              ...
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case04">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="casestudy_txt">
              ...
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case05">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="casestudy_txt">
              <h4>PHR製品の拡張と展開</h4>
              <p>
                インテグリティ・ヘルスケアの技術フェロー(非常勤)に就任し、健康経営をテーマとしたSaaS事業に従事。同社のPHR製品の拡張機能群を開発しました。
              </p>
              <div className="btn_detail_g">
                <a href="/corporate/case-study/#case06">
                  詳細を見る<span className="arrow-right"></span>
                </a>
              </div>
            </div>
