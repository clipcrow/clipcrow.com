export default (props: { title?: string, url?: string, image?: string, description?: string }) => (
  <>
    ...
    <meta property="og:title" content={props.title || "クリップクロウ合同会社"} />
    <meta property="og:url" content={props.url || "https://www.clipcrow.com/"} />
