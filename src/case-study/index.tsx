    ...
    <section className="main_contents">
      ...
      <article id="case01" className="case_item">
        ...
        <div className="case_contents">
          <p>2020年1月よりプロジェクトの中心として開発チームの組成やアーキテクチャから実行した。開発するEHRはSaaSとして、Google Cloud上で実装。開発体制は最大時には50名規模となった。2022年6月まで従事した。</p>
      ...
      <article id="case02" className="case_item">
        ...
        <div className="case_contents">
          <p>2020年9月コロナ禍の下、助成金による医療機関ICT実証実験プロジェクトが募集されたときに採択されたいくつかの組織のうちの一つ。国立大学医学部附属病院への実証実験プロジェクト実施支援の依頼があり参画。RFP 作成を支援し、他方、大学との協働にて応札書類を作成した。その後の開発全量について受託した。</p>
      ...
      <article id="case04" className="case_item">
        ...
        <div className="case_contents">
          <p>2023年4月〜2024年4月に、大手運輸会社グループ向けで、遠隔診療システムをフルスクラッチ開発した。ドライバー向けスマートフォンアプリ、医療機関と薬局向けWEBアプリからなる。計画当初から顧客グループ外へのSaaS提供を想定していた。</p>
          <div className="case_txt">
            <h3>内容</h3>
            <ul>
              <li>遠隔診療所と遠隔薬局をTwilio APIで実現。APIのEoSにより今後はZoom APIへ移行を予定</li>
      ...
      <article id="case05" className="case_item">
        ...
        <div className="case_contents">
          <p>2023年5月〜2024年3月に、プロジェクト2期にわたって、健康経営を行う大企業において従業員の日々の運動をポイント評価し、そのポイントをギフトに引き換えられるようにするSaaSを開発した。</p>
          <div className="case_txt">
            <h3>内容</h3>
            <ul>
      ...
      <article id="case06" className="case_item">
        ...
        <div className="case_contents">
          <p>2022年7月より Medtech スタートアップのインテグリティ・ヘルスケアとSIパートナーシップを構築。その後、同社の技術フェロー(非常勤)に就任した。PHR製品の拡張機能群を開発し、現在も引き続き実施中。</p>
          <div className="case_txt">
            <h3>内容</h3>
            <ul>
            <li><a href="https://www.integrity-healthcare.co.jp/" target="_blank">株式会社インテグリティ・ヘルスケア</a></li>
