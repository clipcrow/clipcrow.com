...
export default () => (
  <EWwareContentsWrapper css="company" id="">
    ...
    <section class="business">
      <h2>
        製品事業の創造と、<br />開発案件プロデュース
      </h2>
      <div class="business-diagram">
        <img
          srcset="/images/business-image-sp.svg 600w,/images/business-image-pc.svg"
          alt=""
        />
      </div>
      <div class="teams">
        <div class="teambox team-dev">
          ...
          <div class="inner">
            <div class="image">
              <img src="/images/team-dev.png" alt="" />
            </div>
            <ul>
        ...
        <div class="teambox team-cc">
          ...
          <div class="inner">
            <div class="image">
              <img src="/images/team-cc.png" alt="" />
            </div>
            <ul>
              <li>案件コンソーシアム運営</li>
